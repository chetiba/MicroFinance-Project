package tn.esprit.gnbapp.handler;

import com.fasterxml.jackson.databind.ObjectMapper;
import tn.esprit.gnbapp.domain.dto.MessageDto;
import tn.esprit.gnbapp.domain.dto.MessageResponse;
import tn.esprit.gnbapp.domain.dto.RiddlesDto;
...
public class ChatWebSocketHandler extends TextWebSocketHandler {
    ...
    protected void handleTextMessage(WebSocketSession session, TextMessage message) throws Exception {
        ...
        try {
            ...
            session.sendMessage(new TextMessage(mapper.writeValueAsString(MessageDto.builder().message("I am not available right now sorry").build())));
            return;
        }
